...
#include <memory>
#include "../../../../../../inc_files/GUI/MainScreen.h"
...
QT_MOC_LITERAL(1, 11, 14), // "catalogClicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "MainScreen\0catalogClicked\0"
};
...
void MainScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->catalogClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScreen::catalogClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainScreen::catalogClicked()
{
